        ...
        <table class="text-xs bg-white shadow-md table-fixed table-compact">
            ...
            <tbody>
                ...
                <tr classs="border border-black">
                    ...
                    <td class="text-xs text-right border border-black">{{number_format($rxi->beg_bal * $rxi->current_price->dmduprice,2)}}</td>
                    <td class="text-xs text-right border border-black">{{number_format($rxi->purchased)}}</td>
                    <td class="text-xs text-right border border-black">{{number_format($rxi->purchased * $rxi->current_price->dmduprice,2)}}</td>
                    <td class="text-xs text-right border border-black">{{number_format($rxi->available())}}</td>
                    <td class="text-xs text-right border border-black">{{number_format($rxi->current_price->dmduprice,2)}}</td>
                    <td class="text-xs text-right border border-black">{{number_format($rxi->available_amount(),2)}}</td>
                    ...
                    <td class="text-xs text-right border border-black">{{number_format($rxi->current_price->dmselprice,2)}}</td>
                    <td class="text-xs text-right border border-black">{{number_format($rxi->total_sales(), 2)}}</td>
                    <td class="text-xs text-right border border-black">{{number_format($rxi->total_cogs(), 2)}}</td>
                    <td class="text-xs text-right border border-black">{{number_format($rxi->total_profit(), 2)}}</td>
                    <td class="text-xs text-right border border-black">{{number_format($rxi->ending_balance(), 2)}}</td>
                    <td class="text-xs text-right border border-black">{{number_format($rxi->ending_balance() * $rxi->current_price->dmduprice, 2)}}</td>
                </tr>
                @empty
                <tr>
