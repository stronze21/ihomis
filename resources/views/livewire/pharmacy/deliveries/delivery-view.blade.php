                    ...
                    <div class="w-full form-control">
                        ...
                        <select class="select select-bordered select2" id="dmdcomb">
                            ...
                            @foreach ($drugs as $drug)
                                <option value="{{ $drug->dmdcomb }},{{ $drug->dmdctr }}">{{ $drug->generic->gendesc }}, {{ $drug->brandname }} {{ $drug->dmdnost }} {{ $drug->strength->stredesc ?? $drug->strecode }} {{ $drug->form->formdesc ?? $drug->formcode }} {{ $drug->route->rtedesc }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="w-full form-control">
